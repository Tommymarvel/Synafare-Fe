      ...
      <div className="space-y-6">
        <div className="rounded-lg border border-gray p-[18px] w-full">
          <div className="flex gap-x-[13px] items-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-mikado-yellow capitalize">
        ...
        <div className="rounded-lg border border-gray w-full">
          ...
          <div className="p-5 grid grid-cols-3 gap-y-[30px] justify-between">
            <InfoDetail title="First Name" value={user.first_name || ''} />
            <InfoDetail title="Last Name" value={user.last_name || ''} />
            <InfoDetail
              title="Business Type"
              value={user.nature_of_solar_business || ''}
            />
            <InfoDetail title="Email Address" value={user.email || ''} />
            <InfoDetail title="Phone Number" value={user.phn_no || ''} />
            <InfoDetail
