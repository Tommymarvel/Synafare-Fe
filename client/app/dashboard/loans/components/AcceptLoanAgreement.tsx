...
// export default function AcceptLoanAgreement({ open, onClose, onAccept, loan }: Props) {
...
//     try {
//       setSigning(true);
//       const id = 'someLoanId'; // Replace 'someLoanId' with the actual loan ID
//       await axiosInstance.post(`/loan/${id}/agreement`, {
//         actionType: "signed"
//       });
//       onAccept();
