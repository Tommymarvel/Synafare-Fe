...
const ViewTransactionReceipt = ({
  ...
  const downloadReceipt = async () => {
    ...
    pdf.save(receipt.trx_id + '_' + receipt.createdAt + '.pdf');
  };
                ...
                <ul className="text-[#515151] space-y-[30px]">
                  ...
                  <li className="flex justify-between">
                    ...
                    <div className="capitalize">
                      {receipt.trx_type.replace(/_/g, ' ')}
                    </div>
                  </li>
                  <li className="flex justify-between">
                    <div>Amount</div>
                    <div>{formatWalletBalance(receipt.trx_amount)}</div>
                  </li>
                  ...
                  <li className="flex justify-between">
                    ...
                    <div>{receipt.trx_id}</div>
                  </li>
                  {receipt.ref_id && (
                    <li className="flex justify-between">
                      <div>Reference ID</div>
                      <div>{receipt.ref_id}</div>
                    </li>
                  )}
                  <li className="flex justify-between">
                    <div>Status</div>
                    <div>
                      <Status status={receipt.trx_status} />
                    </div>
                  </li>
                </ul>
              </div>
