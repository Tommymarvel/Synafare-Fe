    ...
    <div>
      ...
      <div className="space-y-5">
        <div className="flex gap-x-[13px]">
          ...
          <div className="rounded-[6px] flex-1 border border-gray-4 text-resin-black py-8 px-4 flex items-center justify-between">
            <div className="space-y-[6px]">
              <h3 className="text-[13px]">Verification Requests</h3>
              <p className="text-lg font-medium">246</p>
            </div>
            <div className="w-10 h-10 flex items-center justify-center bg-gray-4 rounded-full">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
          ...
          <div className="rounded-[6px] flex-1 border border-gray-4 text-resin-black py-8 px-4 flex items-center justify-between">
            <div className="space-y-[6px]">
              <h3 className="text-[13px]">Total Users</h3>
              <p className="text-lg font-medium">3,246</p>
            </div>
            <div className="w-10 h-10 flex items-center justify-center bg-gray-4 rounded-full">
              <svg
                width="21"
          ...
          <div className="rounded-[6px] flex-1 border border-gray-4 text-resin-black py-8 px-4 flex items-center justify-between">
            <div className="space-y-[6px]">
              <h3 className="text-[13px]">Total Loans</h3>
              <p className="text-lg font-medium">178</p>
            </div>
            <div className="w-10 h-10 flex items-center justify-center bg-gray-4 rounded-full">
              <svg
                width="20"
        ...
        <CardWrapper className="text-sm px-0 mb-12 pb-0">
          ...
          <div className="bg-gray-4 border border-gray-200 text-resin-black"></div>
          ...
          <Table className="">
            ...
            <TableBody>
              <TableRow className="border-b border-b-gray-200">
                ...
                <TableStatus status="Pending">Pending</TableStatus>
              ...
              <TableRow className="border-b border-b-gray-200">
                ...
                <TableCell className="p-6">₦1,181,675</TableCell>
                <TableCell className="p-6">Jan 6, 2025</TableCell>
                <TableStatus status="Successful">Successful</TableStatus>
                <TableCell className="text-[#E2A109] p-6">View</TableCell>
              </TableRow>
            </TableBody>
          </Table>
