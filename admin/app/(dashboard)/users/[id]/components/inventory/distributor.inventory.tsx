    ...
    <Tabs defaultValue="inventory" className="w-full space-y-5">
      <TabsList className=" rounded-none flex gap-x-[11px]">
        <TabsTrigger
          ...
          value="inventory"
        >
          <button className=" block border-gray-300 text-gray-3 border py-2 px-3 font-medium rounded-md data-[state=active]:border-none data-[state=active]:bg-secondary-4 data-[state=active]:text-[#E2A109]">
            Received Quotes
          </button>
        </TabsTrigger>
        <TabsTrigger
      ...
      <TabsContent value="inventory">
        <DistEmbededInventory data={inventoryData} />
      </TabsContent>
