// app/(loans)/components/ActiveLoanTable.tsx
'use client';
...
export default function ActiveLoanTable({ data }: Props) {
  ...
  const activeLoans = data.filter((l) => l.loanStatus === STATUSCONST.ACTIVE);
