...
const SettingsCategory = () => {
  ...
  return (
    <>
      <AddNewCategory
        open={OpenNewCatModal}
        onOpenChange={setOpenNewCatModal}
      />
      <UpdateCatgory
        data={selectedCat}
        open={EditCatModal}
        onOpenChange={setEditCatModal}
      />
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-200 py-3 px-6 border-none">
              ...
              <TableHead className="py-[13px] ps-6 w-1/6">Role</TableHead>
              ...
              >
                ...
                <TableCell className="p-6 font-medium">
                  <div className="flex gap-x-1">
                    <button
                      onClick={() =>
                        handleUpdatedCat({ name: inv.name, id: inv.id })
                      }
